        ...
        function endGame(winner, reason) {
            ...
            // Only update rating for real online games (not AI, not local pass & play)
            const isRatedGame = gameState.gameMode !== 'solo' && !gameState.vsAI && onlineState.roomId;

            if (isRatedGame) {
                let opponentRating = 2.0 + Math.random() * 3.0;
